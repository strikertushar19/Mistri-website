      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          <div className="md:col-span-1">
            ...
            >
              Your AI Software Architect for tech stack analysis and optimization. Transform complex systems into clear insights.
            </motion.p>
            {/* <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
...
{/* 
          ...
          >
            ...
            <ul className="space-y-4">
              <li><a href="/about" className="text-white/70 hover:text-white hover:opacity-100 transition-all duration-300 hover:translate-x-1 inline-block cursor-pointer">About</a></li>
            </ul>
          </motion.div>
        </div>
        ...
        >
          <p className="text-white/60 text-sm">
            © 2025 MISTRI TECH PRIVATE LIMITED. All rights reserved.
          </p>
