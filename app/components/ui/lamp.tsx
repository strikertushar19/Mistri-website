        ...
        >
            <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
                <motion.div
                    ...
                    className="absolute right-1/2 h-56 w-[30rem] overflow-visible text-white bg-conic-purple"
                >
                    <div className="absolute  w-[100%] left-0 h-40  from-purple-500 via-transparent to-transparent bottom-0 z-20 [mask-image:linear-gradient(to_top,white,transparent)]" />
                    <div className="absolute  w-40 h-[100%] left-0  from-purple-500 via-transparent to-transparent bottom-0 z-20 [mask-image:linear-gradient(to_right,white,transparent)]" />
                </motion.div>
                <motion.div
                    initial={{ opacity: 0.5, width: "15rem" }}
                    whileInView={{ opacity: 1, width: "30rem" }}
